...
def main():
    ...
    parser = argparse.ArgumentParser(description='Generate base64-encoded Docker registry credentials.')
    parser.add_argument('--registry', required=True, help='The Docker registry URL')
    parser.add_argument('--account', required=True, help='The robot account for the registry')
    parser.add_argument('--secret', required=True, help='The secret or password for the robot account')
